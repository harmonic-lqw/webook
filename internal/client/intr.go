...
type InteractiveClient struct {
	...
	local  *LocalInteractiveServiceAdapter

	threshold *atomicx.Value[int32]
}

func NewInteractiveClient(remote intrv1.InteractiveServiceClient, local *LocalInteractiveServiceAdapter) *InteractiveClient {
